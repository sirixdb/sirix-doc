...
\title{Sirix - Beyond Versioning of Persistent Tree-Structures}
...
\begin{keywords}
Versioning, Git, SVN, Mercurial, Revision, Diffing, XML, JSON, Storage, Visual Analytics
\end{keywords}
...
We face the problem of having to cope with increasingly large data sets due 
